...
__all__ = ["AudioSource", "Frame", "LatestSlot", "RingBuffer",
           "Fb2kSource", "LoopbackSource", "ToneSource"]


def __getattr__(name):
    # Import perezoso: loopback depende de pyaudiowpatch (solo Windows) y fb2k
    # de websockets. Importar el paquete no debe exigir ambas.
    if name == "Fb2kSource":
